  ...
  <!--E_Mall 以及图片盒子 -->
      ...
      <br> <br> <br> <br> <br>
      	<form action="/updateNotice" method="post">
	      	...
	      	<input type="text" name="noticeTitle" style="width:400px;height:25px;" value="${notice.noticeTitle}"/>
	      	<br><br>
	      	<div style="width:600px;font-size:25px;font-weight:bold;margin-left:80px;">公告内容:</div>
	      	<input type="text" name="noticeId" value="${notice.noticeId}" hidden="true">
	      	<br>
			<textarea style="margin-left:100px" name="noticeContent" cols="73" rows="15" wrap="VIRTUAL">${notice.noticeContent} 
			</textarea> 
